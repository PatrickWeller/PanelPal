...
class TestCompareBedfilesArgs:
    '''
    Tests for the command line arguments for the main function 
    which compares the contents of two bed files.
    '''
    # Mocking file reading function
    @pytest.fixture
    def mock_read_bed_file(self):
        '''
...
class TestCompareBedfilesMain:
    '''
    Tests for the actions of the main function which compares the 
    contents of two bed files under different circumstances.
    '''
    ...
    def test_main_with_temp_files(self, temp_bed_files):
        """
