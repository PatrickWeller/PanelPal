...
class TestDatabase(unittest.TestCase):
    ...
    def test_fetch_patients(self):
        ...
        ''', ('6/11/24', 'John Doe', '01/01/01', '1234567890', 'R56', 
              'BRCA1,BRCA2', 'http://example.com/bamfile.bam'))
        self.conn.commit()
        ...
        expected = (1, '6/11/24', 'John Doe', '01/01/01', '1234567890', 'R56', 
                    'BRCA1,BRCA2', 'http://example.com/bamfile.bam')
    ...
    def test_unique_nhs_id(self):
        ...
        with self.assertRaises(sqlite3.IntegrityError):
            ...
            ''', ('7/11/24', 'Jane Doe', '02/02/02', '1234567890', 'R78', 
                  'TP53', 'http://example.com/anotherfile.bam'))
            self.conn.commit()
